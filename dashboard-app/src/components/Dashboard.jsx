...
export function Dashboard() {
    ...
    const getDataOnDate = async (date) => {
        const res = await fetch("http://dashboardv2-test.herokuapp.com/api/params/search/" + date)
    ...
    useEffect(() => {
        const fetchAir = async () => {
            const socket = io("http://dashboardv2-test.herokuapp.com", {
            ...
            const currentRes = await fetch("http://dashboardv2-test.herokuapp.com/api/params/last")
    ...
    return (
        <div style={styles}>
            <div className="col-3">
                ...
                <MyCalendar getData={getDataOnDate} resetData={getDayData}/>
            </div>
            <div className="col-9">
